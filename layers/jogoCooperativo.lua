...
function JogoCooperativo:drawPlacarCooperativo()
    ...
    local fonte = love.graphics.newFont("midia/fontes/PixelifySans-VariableFont_wght.ttf", 28)
    ...
    -- tempo
    love.graphics.print("T: " .. math.floor(info.tempo / 60) .. ":" .. string.format("%02d", info.tempo % 60), 1025, 150)
    --modo
    ...
    if info.tempo <= 30 and info.tempo > 0 then
        ...
        love.graphics.setFont(fonte, 36)
