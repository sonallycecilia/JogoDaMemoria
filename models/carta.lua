...
function carta.novo(id, caminhoImagemFrente, caminhoImagemVerso)
    ...
    local nova = {
        ...
        revelada = false,
        largura = 250,  -- Defina o tamanho fixo desejado
        altura = 310,   -- Defina o tamanho fixo desejado
        x = 0,  -- Posição X da carta
        y = 0   -- Posição Y da carta
    }
    
    -- Associa a tabela 'carta' à nova instância
...
-- Método para desenhar a carta com redimensionamento
function carta:draw()
